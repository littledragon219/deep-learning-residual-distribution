...
class DCNN(nn.Module):
    def __init__(self, input_size, num_classes):
        ...
        self.conv2 = nn.Conv1d(10, 10, kernel_size=10, padding='same')
        self.batch_norm2 = nn.BatchNorm1d(10)
        
        self.conv3 = nn.Conv1d(10, 10, kernel_size=10, padding='same')
        self.batch_norm3 = nn.BatchNorm1d(10)
        
        self.conv4 = nn.Conv1d(10, 10, kernel_size=10, padding='same')
        self.batch_norm4 = nn.BatchNorm1d(10)
        
        self.conv5 = nn.Conv1d(10, 10, kernel_size=10, padding='same')
...
# 加载模型权重
model.load_state_dict(torch.load("DCNNbest_fault_diagnosis_model.pth"))
model.eval()  # 设置为评估模式
